...
import { AnimatedBeam } from "src/magicUi/ui/animated-beam";
...
const Icons = {
  ...
  DoctorIcon: () => (
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      <path d="M12 2a4 4 0 1 1 0 8 4 4 0 0 1 0-8z" fill="#4CAF50" />
      <path d="M4 22v-2a4 4 0 0 1 4-4h8a4 4 0 0 1 4 4v2" fill="none" stroke="#333" strokeWidth="2" />
      <path d="M9 12h6v1c0 2.21-1.79 4-4 4s-4-1.79-4-4v-1h2z" fill="#4CAF50" />
      <path d="M16 12a1 1 0 0 1 1 1v1a2 2 0 1 1-4 0v-1a1 1 0 0 1 1-1h2z" fill="none" stroke="#333" strokeWidth="2" />
    </svg>
  ),
  googleDocs: () => (
    <svg
