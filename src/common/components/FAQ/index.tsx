    ...
    return (
        <>
            <section
                ...
                className="relative overflow-hidden flex flex-col items-center justify-center  py-12 sm:py-20"
            >
                <div className="relative">
                    ...
                    <div className="mx-10 sm:mx-auto mt-16 grid max-w-xl divide-y divide-gray-300">
                        {faqs.map((faq, index) => (
                                ...
                                <div className="group">
                                    ...
                                    >
                                        <span className={`text-sm transition-all ${
                                            openIndex === index ? 'font-semibold text-gray-800' : 'font-normal text-gray-600'
                                        }`}
                                        >
                                            {faq.question}
                                        </span>
