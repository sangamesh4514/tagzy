...
const Greet = () => {
  return (
    <>
        <div className='flex flex-col justify-center items-center bg-gradient-to-r from-cyan-500 to-green-400 p-4 mx-auto mt-2 rounded-t-md w-fit min-h-fit'>
            <div>
                <button className='bg-gradient-to-r from-sky-500 to-indigo-500 text-white p-3 rounded-full' disabled>
                    <svg 
                        xmlns="http://www.w3.org/2000/svg" 
                        fill="none" viewBox="0 0 24 24" 
                        strokeWidth={3.0} stroke="currentColor" 
